...
import { ChatCompletionFunctionRunnerParams } from "./ChatCompletionRunner.js";
import { ChatCompletionStreamingFunctionRunnerParams } from "./ChatCompletionStreamingRunner.js";
export declare abstract class AbstractChatCompletionRunner<Events extends CustomEvents<any> = AbstractChatCompletionRunnerEvents> {
    ...
    protected _addMessage(message: ChatCompletionMessage | ChatCompletionMessageParam, emit?: boolean): void;
    ...
    protected _runFunctions<FunctionsArgs extends BaseFunctionsArgs>(completions: Completions, params: ChatCompletionFunctionRunnerParams<FunctionsArgs> | ChatCompletionStreamingFunctionRunnerParams<FunctionsArgs>, options?: Core.RequestOptions & {
