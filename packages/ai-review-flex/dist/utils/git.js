...
export const postReviewComment = async (path, startLine, endLine, body) => {
    try {
        const octokit = getOctokit();
        const { owner, repo } = getOwnerAndRepo();
...
export const getDiff = (base, head) => {
